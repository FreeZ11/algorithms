...
public class L3z1 {
    ...
    public static void main(String[] args) {
            ...
            for (int n = 100; n <= 100000; n += 100) {
                ...
                for (int i = 0; i < k; i++) {
                    ...
                    if (args[1].equals("merge")) {
                        ...
                        try {
                            writeResult(n, merge_comp_counter+merge_swap_counter, timeTaken, UsedMem, args[5]);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    ...
                    if (args[1].equals("insertion")) {
                        ...
                        double timeTaken = endTime - startTime;
                        try {
                            writeResult(n, insertion_compares+insertion_swaps, timeTaken, UsedMem, args[5]);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        insertion_swaps = 0;
                    ...
                    if (args[1].equals("quick")) {
                        ...
                        double timeTaken = endTime - startTime;
                        try {
                            writeResult(n, quick_comp_counter+quick_swap_counter, timeTaken, UsedMem, args[5]);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    ...
                    if(args[1].equals("radix")){
                        double startTime = System.nanoTime();

                        radixSort(numbers,n,args[3]);
                        ...
                        double timeTaken = endTime - startTime;
                        try {
                            writeResult(n,radix_operations,timeTaken, UsedMem,args[5]);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        radix_operations = 0;
        ...
        if(args[1].equals("radix")){
            ...
            System.out.println("liczba operacji wyniosla: "+radix_operations);
            System.out.println("Sortowanie trwało: " + timeTaken + " nanosekund");
        }
        for (int l : numbers) {
            System.out.print(l + " ");
    ...
    static void writeResult(int data_size, int operations, double time, double mem, String where) throws IOException {
        FileWriter fileWriter = new FileWriter(where,true);
        PrintWriter writer = new PrintWriter(fileWriter);
        writer.println(data_size+";"+operations+";"+time+";"+mem);
        writer.close();
    }
    ...
    static void countSort(int arr[], int n, int exp, String sign){
    ...
    static void radixSort(int arr[], int n, String sign){
