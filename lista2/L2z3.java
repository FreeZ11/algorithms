...
public class L2z3 {
    ...
    static void DualPivotQuickSort(int numbers[],int low, int high){
        ...
        DualPivotQuickSort(numbers, low, h - 1);
        DualPivotQuickSort(numbers, h + 1, l - 1);
        DualPivotQuickSort(numbers, l + 1, high);
    }
}
